...
class AdType extends ApplicationType
{
    ...
    {
        $builder
            ->add('title', TextType::class,$this->getConfiguration("Titre","Tapez un titre pour vote annonce"))
            ...
            ->add('introduction',TextType::class, $this->getConfiguration("Indrotuction","Donnez une description global de l'annonce"))
